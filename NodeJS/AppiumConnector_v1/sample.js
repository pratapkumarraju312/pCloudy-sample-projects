                            ...
                            if(bookedDevDetails.hasOwnProperty('error')){
                                ...
                                pcloudyConnectorServices.initAppiumHubForApp(bookedDevDetails.token, uploadedApp).then(function(initAppiumHubForAppStat) {
                                                  ...
                                                  if(initHubresp.hasOwnProperty('error')){
                                                      ...
                                                      logger.debug("calling getAppiumEndPoint ");
                                                          ...
                                                          if(endPoint.hasOwnProperty('error')){
                                                              ...
                                                              var totalBokkedDevs = bookedDevices.length;
                                                                  ...
                                                                  bookedDevices.forEach(function(i, index, bookedDevices) {
                                                                      ...
                                                                      timeConverter(unixTime).then(function(readableTime) {
									  ...
									  logger.info('Releasing the Appium Session');
                                                                                ...
                                                                                if(releaseStat.hasOwnProperty('error')){
                                                                                    logger.error(" There was a error while releasing appium session "+releaseStat.error);
                                                                                }else{
                                                                                    logger.info('Status of Appium session release for model : '+model + ' ==  '  +releaseStat.msg);
                                                                                }
                                                                            },function(releaseAppiumsessionErr){
                                                                                logger.error('releaseAppiumsession '+JSON.stringify(releaseAppiumsessionErr));
                                                                            })
                                                                      },60000)
                                                                      /*################################################## Add your code ################################################*/
            ...
            rl.question('====================== choose any one platform  ========================= \n 1 : Android \n  ========= Enter 1 to choose ============= \n', (platform) => {
                ...
                var present = false;
                                ...
                                pcloudyConnectorServices.GetAvailableApps(token, 0, 'all').then(function(filesinDrive) {
                                    ...
                                    alreadyPresentfiles = alreadyPresentfiles.result;
                                    ...
                                    if(alreadyPresentfiles.hasOwnProperty('error')){
                                        ...
                                        if(!present){
                                            ...
                                            //core
                                            appiumCore(token,devicePlatform,app,configs).then(function(appiumLaunchStatus){
                                                logger.info("Status of pcloudy Appium Service Launch == > "+appiumLaunchStatus.status);
